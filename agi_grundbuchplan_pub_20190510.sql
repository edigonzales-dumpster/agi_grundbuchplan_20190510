...
-- SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Boflaechesymbol
CREATE TABLE agi_grundbuchplan_pub.grundbuchplan_boflaechesymbol (
...
;
CREATE INDEX grundbuchplan_boflchsymbol_pos_idx ON agi_grundbuchplan_pub.grundbuchplan_boflaechesymbol USING GIST ( pos );
COMMENT ON TABLE agi_grundbuchplan_pub.grundbuchplan_boflaechesymbol IS 'Symbole der Bodenbedeckungsobjekte';
COMMENT ON COLUMN agi_grundbuchplan_pub.grundbuchplan_boflaechesymbol.art_txt IS 'Bodenbedeckungsart';
COMMENT ON COLUMN agi_grundbuchplan_pub.grundbuchplan_boflaechesymbol.pos IS 'Position';
COMMENT ON COLUMN agi_grundbuchplan_pub.grundbuchplan_boflaechesymbol.rot IS 'Orientierung';
COMMENT ON COLUMN agi_grundbuchplan_pub.grundbuchplan_boflaechesymbol.bfs_nr IS 'Gemeindenummer';
COMMENT ON COLUMN agi_grundbuchplan_pub.grundbuchplan_boflaechesymbol.lieferdatum IS 'Lieferdatum';
-- SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Grenzpunkt
CREATE TABLE agi_grundbuchplan_pub.grundbuchplan_grenzpunkt (
  T_Id bigint PRIMARY KEY DEFAULT nextval('agi_grundbuchplan_pub.t_ili2db_seq')
  ,T_Ili_Tid uuid NULL DEFAULT uuid_generate_v4()
  ,bfs_nr integer NOT NULL
  ,gueltigkeit varchar(20) NOT NULL
  ,punktzeichen varchar(40) NOT NULL
...
COMMENT ON COLUMN agi_grundbuchplan_pub.grundbuchplan_grenzpunkt.gueltigkeit IS 'Gueltigkeit';
COMMENT ON COLUMN agi_grundbuchplan_pub.grundbuchplan_grenzpunkt.punktzeichen IS 'Art des Punktzeichens';
COMMENT ON COLUMN agi_grundbuchplan_pub.grundbuchplan_grenzpunkt.geometrie IS 'Grenzpunktgeometrie';
COMMENT ON COLUMN agi_grundbuchplan_pub.grundbuchplan_grenzpunkt.mutation IS 'Grenzpunkt in Mutation (ja/nein).';
-- SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Grundstueckpos
...
COMMENT ON COLUMN agi_grundbuchplan_pub.grundbuchplan_grundstueckpos.pos IS 'Geometrie';
...
COMMENT ON COLUMN agi_grundbuchplan_pub.grundbuchplan_grundstueckpos.hilfslinie IS 'Hilfslinie';
COMMENT ON COLUMN agi_grundbuchplan_pub.grundbuchplan_grundstueckpos.bfs_nr IS 'Gemeindenummer';
COMMENT ON COLUMN agi_grundbuchplan_pub.grundbuchplan_grundstueckpos.lieferdatum IS 'Lieferdatum';
COMMENT ON COLUMN agi_grundbuchplan_pub.grundbuchplan_grundstueckpos.y IS 'E-Koordinate';
COMMENT ON COLUMN agi_grundbuchplan_pub.grundbuchplan_grundstueckpos.x IS 'N-Koordinate';
COMMENT ON COLUMN agi_grundbuchplan_pub.grundbuchplan_grundstueckpos.rot IS 'Orientierung';
COMMENT ON COLUMN agi_grundbuchplan_pub.grundbuchplan_grundstueckpos.nummer IS 'Nummer des Grundstücks';
COMMENT ON COLUMN agi_grundbuchplan_pub.grundbuchplan_grundstueckpos.art IS 'Art des Grundstücks (Integer-Repräsentation)';
COMMENT ON COLUMN agi_grundbuchplan_pub.grundbuchplan_grundstueckpos.mutation IS 'In Mutation (ja/nein)';
-- SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Liegenschaft
...
COMMENT ON COLUMN agi_grundbuchplan_pub.grundbuchplan_liegenschaft.flaechenmass IS 'Fläche der Liegenschaft';
COMMENT ON COLUMN agi_grundbuchplan_pub.grundbuchplan_liegenschaft.bfs_nr IS 'Gemeindenummer';
COMMENT ON COLUMN agi_grundbuchplan_pub.grundbuchplan_liegenschaft.lieferdatum IS 'Lieferdatum';
COMMENT ON COLUMN agi_grundbuchplan_pub.grundbuchplan_liegenschaft.numpos IS 'Position der Nummer als WKT-String';
COMMENT ON COLUMN agi_grundbuchplan_pub.grundbuchplan_liegenschaft.nummer IS 'Grundstücknummer';
COMMENT ON COLUMN agi_grundbuchplan_pub.grundbuchplan_liegenschaft.mutation IS 'In Mutation (ja/nein)';
...
;
ALTER TABLE agi_grundbuchplan_pub.grundbuchplan_boflaechesymbol ADD CONSTRAINT grundbuchplan_bflchsymbol_rot_check CHECK( rot BETWEEN 0 AND 360);
ALTER TABLE agi_grundbuchplan_pub.grundbuchplan_boflaechesymbol ADD CONSTRAINT grundbuchplan_bflchsymbol_bfs_nr_check CHECK( bfs_nr BETWEEN 1 AND 9999);
ALTER TABLE agi_grundbuchplan_pub.grundbuchplan_grenzpunkt ADD CONSTRAINT grundbuchplan_grenzpunkt_bfs_nr_check CHECK( bfs_nr BETWEEN 1 AND 9999);
ALTER TABLE agi_grundbuchplan_pub.grundbuchplan_grundstueckpos ADD CONSTRAINT grundbuchplan_grndstckpos_bfs_nr_check CHECK( bfs_nr BETWEEN 1 AND 9999);
ALTER TABLE agi_grundbuchplan_pub.grundbuchplan_grundstueckpos ADD CONSTRAINT grundbuchplan_grndstckpos_y_check CHECK( y BETWEEN 2000000.0 AND 3000000.0);
ALTER TABLE agi_grundbuchplan_pub.grundbuchplan_grundstueckpos ADD CONSTRAINT grundbuchplan_grndstckpos_x_check CHECK( x BETWEEN 1000000.0 AND 2000000.0);
ALTER TABLE agi_grundbuchplan_pub.grundbuchplan_grundstueckpos ADD CONSTRAINT grundbuchplan_grndstckpos_rot_check CHECK( rot BETWEEN -270.0 AND 90.0);
ALTER TABLE agi_grundbuchplan_pub.grundbuchplan_grundstueckpos ADD CONSTRAINT grundbuchplan_grndstckpos_art_check CHECK( art BETWEEN 0 AND 5);
ALTER TABLE agi_grundbuchplan_pub.grundbuchplan_liegenschaft ADD CONSTRAINT grundbuchplan_liegnschaft_flaechenmass_check CHECK( flaechenmass BETWEEN 0 AND 2147483647);
ALTER TABLE agi_grundbuchplan_pub.grundbuchplan_liegenschaft ADD CONSTRAINT grundbuchplan_liegnschaft_bfs_nr_check CHECK( bfs_nr BETWEEN 1 AND 9999);
...
;
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Boflaechesymbol','grundbuchplan_boflaechesymbol');
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Grundstueckpos','grundbuchplan_grundstueckpos');
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Liegenschaft','grundbuchplan_liegenschaft');
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Grenzpunkt','grundbuchplan_grenzpunkt');
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Grundstueckpos.Art','art','grundbuchplan_grundstueckpos',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Grundstueckpos.y','y','grundbuchplan_grundstueckpos',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Grundstueckpos.Rot','rot','grundbuchplan_grundstueckpos',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Liegenschaft.BFS_Nr','bfs_nr','grundbuchplan_liegenschaft',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Grenzpunkt.Gueltigkeit','gueltigkeit','grundbuchplan_grenzpunkt',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Grenzpunkt.BFS_Nr','bfs_nr','grundbuchplan_grenzpunkt',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Grundstueckpos.Mutation','mutation','grundbuchplan_grundstueckpos',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Grundstueckpos.Vali_txt','vali_txt','grundbuchplan_grundstueckpos',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Liegenschaft.Lieferdatum','lieferdatum','grundbuchplan_liegenschaft',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Grundstueckpos.Nummer','nummer','grundbuchplan_grundstueckpos',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Boflaechesymbol.Rot','rot','grundbuchplan_boflaechesymbol',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Boflaechesymbol.BFS_Nr','bfs_nr','grundbuchplan_boflaechesymbol',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Boflaechesymbol.Art_txt','art_txt','grundbuchplan_boflaechesymbol',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Grundstueckpos.Hilfslinie','hilfslinie','grundbuchplan_grundstueckpos',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Liegenschaft.Geometrie','geometrie','grundbuchplan_liegenschaft',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Grenzpunkt.Mutation','mutation','grundbuchplan_grenzpunkt',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Boflaechesymbol.Lieferdatum','lieferdatum','grundbuchplan_boflaechesymbol',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Grundstueckpos.Pos','pos','grundbuchplan_grundstueckpos',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Grundstueckpos.Hali_txt','hali_txt','grundbuchplan_grundstueckpos',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Liegenschaft.Numpos','numpos','grundbuchplan_liegenschaft',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Liegenschaft.Flaechenmass','flaechenmass','grundbuchplan_liegenschaft',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Boflaechesymbol.Pos','pos','grundbuchplan_boflaechesymbol',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Grundstueckpos.Lieferdatum','lieferdatum','grundbuchplan_grundstueckpos',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Liegenschaft.Nummer','nummer','grundbuchplan_liegenschaft',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Grundstueckpos.BFS_Nr','bfs_nr','grundbuchplan_grundstueckpos',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Grenzpunkt.Geometrie','geometrie','grundbuchplan_grenzpunkt',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Liegenschaft.Mutation','mutation','grundbuchplan_liegenschaft',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Grenzpunkt.Punktzeichen','punktzeichen','grundbuchplan_grenzpunkt',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Grundstueckpos.x','x','grundbuchplan_grundstueckpos',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Boflaechesymbol','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Grundstueckpos','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Liegenschaft','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Grenzpunkt','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Grundstueckpos',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Liegenschaft',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Grenzpunkt',NULL);
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('SO_AGI_Grundbuchplan_20190510.Grundbuchplan.Boflaechesymbol',NULL);
...
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('grundbuchplan_boflaechesymbol',NULL,'pos','ch.ehi.ili2db.coordDimension','2');
...
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('grundbuchplan_boflaechesymbol',NULL,'pos','ch.ehi.ili2db.geomType','POINT');
...
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('grundbuchplan_boflaechesymbol',NULL,'pos','ch.ehi.ili2db.c2Min','1045000.000');
...
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('grundbuchplan_boflaechesymbol',NULL,'pos','ch.ehi.ili2db.c2Max','1310000.000');
...
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('grundbuchplan_boflaechesymbol',NULL,'pos','ch.ehi.ili2db.c1Min','2460000.000');
...
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('grundbuchplan_boflaechesymbol',NULL,'pos','ch.ehi.ili2db.c1Max','2870000.000');
...
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('grundbuchplan_boflaechesymbol',NULL,'pos','ch.ehi.ili2db.srid','2056');
...
','2019-05-10 15:10:01.955');
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_MODEL (filename,iliversion,modelName,content,importDate) VALUES ('SO_AGI_Grundbuchplan_20190510.ili','2.3','SO_AGI_Grundbuchplan_20190510{ GeometryCHLV95_V1 CHAdminCodes_V1 Units}','INTERLIS 2.3;
...
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.sender','ili2pg-4.1.0-aa1d00a37ee431852bdee6b990f34b3620f9c1c1');
...
INSERT INTO agi_grundbuchplan_pub.T_ILI2DB_META_ATTRS (ilielement,attr_name,attr_value) VALUES ('SO_AGI_Grundbuchplan_20190510','technicalContact','agi@bd.so.ch');
